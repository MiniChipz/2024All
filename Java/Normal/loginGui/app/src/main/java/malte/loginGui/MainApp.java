...
public class MainApp {
    ...
    public void showUserManagement(boolean isAdmin) {
        ...
        JPanel createUserPanel = new malte.loginGui.GUI.createUser(isAdmin).getMainPanel();
        JPanel deleteUserPanel = new malte.loginGui.GUI.DeleteUser(isAdmin).getMainPanel();
