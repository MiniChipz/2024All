...
csv_fil = "C:/Users/Malte/Documents/Programmering/Python/Eksamen/PSG_csv.csv"
    ...
    with open(csv_fil, 'r', newline='') as file:
        ...
        for row in csv_reader:
            ...
            if row[2] == username and row[3] == password:
                ...
                window.close()
                # Laver en popup som skriver man successful blev logget ind
                sg.popup("Du er blevet logget ind.")
                login_successful = True
                return sg.Window("Hovedmenu", layout_startmenu, size=(400, 200), finalize=True)
